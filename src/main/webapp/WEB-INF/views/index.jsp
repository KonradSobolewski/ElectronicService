...
<c:choose>
                ...
                <table class="table table-striped table-hover table-light">
                    ...
                    <c:forEach var="equipment" items="${equipments}">
                        <tr>
                            ...
                            <td>
                                <a href="allComments?id=${equipment.id}">
                                    <span class="btn btn-info">Comment</span>
                                </a>
                            </td>
                            <td>
                ...
                <table class="table table-striped table-hover table-light">
                    ...
                    <c:forEach var="attribute" items="${attributes}">
                        <tr>
                            ...
                            <td>
                                <a href="deleteAttribute?attribute_id=${attribute.id}&id=${attribute.equipment.id}">
                                    <span class="btn btn-info">Delete</span>
                                </a>
                            </td>
                        </tr>
    ...
    <c:when test="${mode == 'MODE_COMMENTS'}">
        <div class="container text-center" id="equipmentDiv">
            <form class="form-horizontal inputForm" method="POST" action="saveComment?id=<%= request.getParameter("id")%>"">
                <div class="form-group ">
                <c:forEach var="comment" items="${comments}">
                    ...
                    <input type="hidden" name="equipment.id" value="<%= request.getParameter("id")%>">
                    <label>
                        <textarea name="commentValue" placeholder="Comment here..." cols="40" rows="4"></textarea>
                    </label>
                    <br/>
                    <input type="submit" class="btn btn-lg btn-info inputComm" value="Comment">
                </div>
            </form>
        </div>
    </c:when>
